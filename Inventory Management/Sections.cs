        ...
        public override void btnDelete_Click(object sender, EventArgs e)
        {
            if (edit == 1)
            {
                ...
                if (dr == DialogResult.Yes)
                {
                    ...
                    del.delete(secID, "st_deletesection", "@id");
                    r.showSections(dgvShowData, secIdGV, descGV);
        ...
        public override void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (edit == 0) // for save operation
                {
                    ...
                    i.insertSection(textDescription.Text);
                    r.showSections(dgvShowData, secIdGV, descGV);
                    MainClass.disable_reset(leftPanel);
                }
                else if (edit == 1) // for edit operation
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        i.updateSection(secID, textDescription.Text);
                        r.showSections(dgvShowData, secIdGV, descGV);
                        MainClass.disable_reset(leftPanel);
                    }
                }
